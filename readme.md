...
# Тестовое задание
## Ответ на первое задание лежит "getRandomElements.ts" и в index.ts
## Ответ на второе задание это совокупность файлов который лежат в дополнительной папке MODEL ,table.ts и index.html 
## Ответ на третье задание лежит 3задние.txt так же в папке model
